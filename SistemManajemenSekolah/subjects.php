...
<div class="container">	
	...
	<div class="content">
		<div class="container-fluid">
			<div>   
				<a href="#"><strong><span class="ti-crown"></span> Bagian Subject</strong></a>
				<hr>		
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-2" align="right">
							<button type="button" name="add" id="addSubject" class="btn btn-success btn-xs">Tambah Subjectt</button>
						</div>
					</div>
				</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<label class="radio-inline">
							<input type="radio" name="s_type" id="theory" value="Theory" required>Teori
						</label>;
						<label class="radio-inline">
							<input type="radio" name="s_type" id="practical" value="Practical" required>Praktek
						</label>							
					</div>	
					<div class="form-group">
