				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-2" align="right">
							<button type="button" name="add" id="addStudent" class="btn btn-success btn-xs">Tambah Siswa</button>
						</div>
					</div>
				</div>
		...
		<form method="post" id="studentForm" enctype="multipart/form-data">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-plus"></i> Edit Siswa</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="mobile" class="control-label">Absen Siswa</label>							
					...
					<div class="form-group">
						<label for="mname" class="control-label">Tahun Ajaran*</label>	
					...
					<div class="form-group">
						<label for="email" class="control-label">Tanggal diterima</label>							
					...
					<div class="form-group">
						<label for="email" class="control-label">Tanggal lahir</label>							
					...
					<div class="form-group">
						<label for="mobile" class="control-label">Nomor Telfon</label>							
					...
					<div class="form-group">
						<label for="fname" class="control-label">Nama Ayah</label>							
						<input type="text" class="form-control" id="fname" name="fname" placeholder="Father name...">							
					</div>	
					<div class="form-group">
						<label for="mname" class="control-label">Nama Ibu</label>							
