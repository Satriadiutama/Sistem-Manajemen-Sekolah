...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Des 2020 pada 15.15
...
--
-- Struktur dari tabel `sms_attendance`
--
...
--
-- Dumping data untuk tabel `sms_attendance`
--
...
--
-- Struktur dari tabel `sms_classes`
--
...
--
-- Dumping data untuk tabel `sms_classes`
--
...
--
-- Struktur dari tabel `sms_section`
--
...
--
-- Dumping data untuk tabel `sms_section`
--
...
--
-- Struktur dari tabel `sms_students`
--
...
--
-- Dumping data untuk tabel `sms_students`
--
...
--
-- Struktur dari tabel `sms_subjects`
--
...
--
-- Dumping data untuk tabel `sms_subjects`
--
...
--
-- Struktur dari tabel `sms_teacher`
--
...
--
-- Dumping data untuk tabel `sms_teacher`
--
...
INSERT INTO `sms_user` (`id`, `email`, `first_name`, `last_name`, `password`, `gender`, `mobile`, `designation`, `image`, `type`, `status`, `authtoken`) VALUES
(1, '', 'web', 'damn', '202cb962ac59075b964b07152d234b70', 'male', '123456789', 'Web developer', '', 'administrator', 'active', ''),
(2, '', 'satriadi', 'utama', 'satria', 'male', '082132643562', 'Mahasiswa', '', 'Anggota', 'active', ''),
(1, '', 'admin', 'admin', 'admin', 'male', '082132643562', 'Mahasiswa', '', 'Anggota', 'active', ''),
(1, 'satriadiutama@yahoo.com', 'satriadi', 'utama', 'satriadi', 'male', '082132643562', 'Web Developer', '', 'Administrator', 'active', '');
...
--
-- Indeks untuk tabel `sms_attendance`
--
ALTER TABLE `sms_attendance`
  ADD PRIMARY KEY (`attendance_id`);

--
-- Indeks untuk tabel `sms_classes`
--
ALTER TABLE `sms_classes`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `sms_section`
--
ALTER TABLE `sms_section`
  ADD PRIMARY KEY (`section_id`);

--
-- Indeks untuk tabel `sms_students`
--
ALTER TABLE `sms_students`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `sms_subjects`
--
ALTER TABLE `sms_subjects`
  ADD PRIMARY KEY (`subject_id`);

--
-- Indeks untuk tabel `sms_teacher`
--
...
--
-- AUTO_INCREMENT untuk tabel `sms_attendance`
--
ALTER TABLE `sms_attendance`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `sms_classes`
--
ALTER TABLE `sms_classes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `sms_section`
--
ALTER TABLE `sms_section`
  MODIFY `section_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `sms_students`
--
ALTER TABLE `sms_students`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `sms_subjects`
--
ALTER TABLE `sms_subjects`
  MODIFY `subject_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `sms_teacher`
--
ALTER TABLE `sms_teacher`
